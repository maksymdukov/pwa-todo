...
interface SWConfig {
  onUpdate?: (registraction: ServiceWorkerRegistration) => void;
  onSuccess?: (registraction: ServiceWorkerRegistration) => void;
}
  ...
  navigator.serviceWorker
    ...
    .then((registration) => {
      if (registration.waiting?.state === "installed") {
        // in case page reloaded and there's still a waiting serviceWorker
